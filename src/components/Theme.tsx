...
import { Div, Label } from "../styles/Theme/Theme";
...
const Theme: FC = () => {
  ...
  return (
    <Div theme={theme.color === "white"}>
      ...
      <input id="white" type="button" value="white" onClick={handleTheme} />
      <Label theme={theme.color === "black"} htmlFor="black">
        <svg
          width="23"
          height="23"
          viewBox="0 0 23 23"
      ...
      <input id="black" type="button" value="black" onClick={handleTheme} />
    </Div>
  );
};
